...
class BListView : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_blist_view) // Verifica que este es el layout correcto
        val listView = findViewById<ListView>(R.id.lv_list_view) // Verifica que lv_list_view exista en activity_blist_view.xml
